...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	...
	<div class='text-muted'>
		Built from the ground up using the Laravel Framework 10 & Bootstrap 4 | Copyright - John Klein - {{ date('Y') }} | <a href="https://github.com/JohnVicious/PersonalPortfolio">GitHub</a> | <a href="https://www.linkedin.com/in/johnkleindeveloper/">LinkedIn</a>
	</div>	
	</div>
    </footer>
</html>
